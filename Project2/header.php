   ...
   <div class="container-fluid" id="navbar-container">
    ...
    <div class="col-md-6 collapse navbar-collapse" id="onepage-nav">
     <ul class="nav navbar-nav ml-auto" id="navigation">
      <li>
        <a href="#header-section" onclick="record('Home')" class="links" data-target="#header-section">Home</a>
      </li>
      <li>
        <a href="#protection-plans" onclick="record('Features')" class="links" data-target="#protection-plans">Features</a>
      </li>
      <li>
        <a href="#situation_image" onclick="record('Savings')" class="links" data-target="#situation_image">Savings</a>
      </li>
      <li>
        <a href="#about-author" onclick="record('About Us')" class="links" data-target="#about-author">About us</a>
      </li>
      <li>
        <a href="#search-intro" onclick="record('SearchBy')" class="links" data-target="#search-intro">SearchBy</a>
      </li>
      <li>
        <a href="#contactUsModal" onclick="record('Contact Us')"  class="links" data-toggle="modal" data-target="#contactUsModal">Contact Us</a>
      </li>
      <li>
 ...
 function record(text){
   $.post("/activity.php", { activity : text }, function(data) {
    alert(data)
 });
 }
